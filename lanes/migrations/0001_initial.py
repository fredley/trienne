# -*- coding: utf-8 -*-
# Generated by Django 1.9.5 on 2016-05-12 19:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('scope', models.IntegerField(choices=[(0, b'All rooms'), (1, b'Only certain rooms')])),
            ],
        ),
        migrations.CreateModel(
            name='BotToken',
        ...
        migrations.AddField(
            model_name='bot',
            name='rooms',
            field=models.ManyToManyField(to='lanes.Room'),
        ),
        migrations.AddField(
            model_name='user',
            name='bot',
