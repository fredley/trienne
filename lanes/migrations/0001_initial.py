# -*- coding: utf-8 -*-
# Generated by Django 1.9.5 on 2016-05-23 13:24
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_image', models.ImageField(blank=True, null=True, upload_to=lanes.models.uuid_filename)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notify_key', models.CharField(default=lanes.models.generate_token, max_length=20)),
                ('scope', models.IntegerField(choices=[(0, 'All rooms'), (1, 'Only certain rooms')], default=1)),
            ],
        ),
        migrations.CreateModel(
            name='BotToken',
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('bot', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='lanes.Bot')),
            ],
        ),
        migrations.CreateModel(
            name='DMRoom',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('privacy', models.IntegerField(choices=[(0, 'Open'), (1, 'Application Only'), (2, 'Invitation Only'), (3, 'Your domain')], default=1)),
                ('visibility', models.IntegerField(choices=[(0, 'Public'), (1, 'Link Only'), (2, 'Private')], default=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.IntegerField(choices=[(0, 'online'), (1, 'away'), (2, 'busy'), (3, 'invisible'), (4, 'offline')], default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('privacy', models.IntegerField(choices=[(0, 'Public'), (1, 'Private')], default=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('volume', models.IntegerField(choices=[(0, 'Quiet - Nothing'), (1, 'Normal - Mentions'), (2, 'Loud - Every message')], default=1)),
        ...
        migrations.AddField(
            ...
            name='post',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='lanes.Post'),
        ),
        migrations.AddField(
            model_name='notification',
            name='user',
        ...
        migrations.AddField(
            model_name='dmroom',
            name='room',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='lanes.Room'),
        ),
        migrations.AddField(
            model_name='dmroom',
            name='user1',
        ...
        migrations.AddField(
            model_name='bot',
            name='organisation',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='org', to='lanes.Organisation'),
        ),
        migrations.AddField(
            model_name='bot',
            name='owner',
        ...
        migrations.AddField(
            model_name='bot',
            name='rooms',
            field=models.ManyToManyField(blank=True, to='lanes.Room'),
        ),
        migrations.AddField(
            model_name='banlog',
            name='organisation',
        ...
        migrations.AddField(
            model_name='user',
            name='bot',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='lanes.Bot'),
        ),
        migrations.AddField(
            model_name='user',
            name='groups',
        ...
        migrations.AddField(
            model_name='user',
            name='subscribed',
            field=models.ManyToManyField(blank=True, related_name='subscribed', to='lanes.Organisation'),
        ),
        migrations.AddField(
            model_name='user',
        ...
        migrations.AlterUniqueTogether(
            name='flag',
            unique_together=set([('post', 'flagger')]),
        ),
        migrations.AlterUniqueTogether(
            name='dmroom',
            unique_together=set([('user1', 'user2', 'org')]),
        ),
    ]
